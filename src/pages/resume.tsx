...
export default function ResumePage() {
	return (
		<Layout>
			<SEO title="Resume" />
			<ResumeContainer className="resumeContainer px-6 pb-6">
				...
				<p><a href={URLS.linkedIn.url} target="_blank">LinkedIn</a> | <a href={URLS.github.url} target="_blank">{URLS.github.name}</a> | <a href={URLS.blog.url} target="_blank">Blog</a> | <Link to={URLS.portfolio.url}>Portfolio</Link> | <a href={URLS.youtube.url} target="_blank">YouTube</a></p>
				...
				<h1 className="has-text-weight-bold has-text-centered is-uppercase mt-1">Technical Skills</h1>
				<Line />
				<p>
				...
				<h1 className="has-text-weight-bold has-text-centered is-uppercase mt-1">Technical Projects</h1>
				<Line />
				<p>
					<span className="has-text-weight-bold">React Redux Portfolio Project / Portfolio Site - <a href={getGithubRepo('portfolio-site')} target="_blank">Github</a> | <a href="https://www.youtube.com/watch?v=Wg42yMQ6dxI&t=1s" target="_blank">Demo</a></span>
					<br />
				...
				<p>
					<span className="has-text-weight-bold">Agile Project - <a href={getGithubRepo('agile-project')} target="_blank">Github</a> | <a href="https://www.youtube.com/watch?v=yQMf8GfuxRA&t=1s" target="_blank">Demo</a></span>
					<br />
				...
				<p>
					<span className="has-text-weight-bold">Rails Address Book - <a href={getGithubRepo('rails-address-book')} target="_blank">Github</a> | <a href="https://www.youtube.com/watch?v=mPOfY_4FgvI&t=3s" target="_blank">Demo</a></span>
					<br />
				...
				<h1 className="has-text-weight-bold has-text-centered is-uppercase mt-1">Experience</h1>
				<Line />
				<p>
					<span className="has-text-weight-bold">Cloud Coach | Fort Collins, Colorado</span>
					<br />
				...
				<p>
					<span className="has-text-weight-bold">The Foundry Cinema and Bowl | Winter Park, Colorado</span>
					<br />
				...
				<h1 className="has-text-weight-bold has-text-centered is-uppercase mt-1">Education</h1>
				<Line />
				<p>
					<span className="has-text-weight-bold">Flatiron School - Online</span>
					<br />
